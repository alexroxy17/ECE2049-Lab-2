...
unsigned int allFrequencies[] = {2,41,44,49,52,55,62,65,73,84,87,92,98,104,110,117, 123,131,139,147,156,156,165,175,185,196,208,220,233,247,262,262,277,277,294,311,330,349,370,392,415,440,466,494,523,554,587,622,622,659,698,740,784,831,831,880,932,932,988,1047, 1109, 1175, 1245, 1319, 1397, 1480, 1568, 1661, 1760, 1865, 1976, 2093, 2217, 2349, 2489, 2637, 2794, 2960, 3136, 3322, 3520, 3729, 3951, 4186, 4435, 4699, 4978};
...
void BuzzerOnFreq(int freq)
{
    ...
    if(actFreq > 20)
    {
        ...
        TB0CCR0   = 32768 / actFreq;        // Set the PWM period in ACLK ticks
